...
public class CrateExpressPreviewSubCommand extends CrateExpressSubCommand {
	public CrateExpressPreviewSubCommand(@NotNull CrateExpress plugin) {
		super(plugin, "preview", "show");
	}
	...
	public boolean canExecute(@NotNull CommandSender sender, @NotNull CrateExpressCommand command, @NotNull String alias, @NotNull String subAlias, @NotNull String @NotNull[] args) {
		return sender instanceof Player && sender.hasPermission(CratePermission.Command.PREVIEW);
	}
